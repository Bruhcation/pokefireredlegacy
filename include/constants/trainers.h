...
#define TRAINER_CLASS_MIRAGE_TRAINER      111
#define TRAINER_CLASS_POKEDUDE            112
#define TRAINER_CLASS_CUE_BALL_LEADER     113
#define TRAINER_CLASS_KARATE_KING         114
