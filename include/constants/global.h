...
#define OPTIONS_MOVE_EFFECTIVENESS_ARROWS  0
#define OPTIONS_MOVE_EFFECTIVENESS_COLOR   1
#define OPTIONS_MOVE_EFFECTIVENESS_BOTH    2
#define OPTIONS_MOVE_EFFECTIVENESS_OFF     3
