...
const u8 gMoveDescription_RazorWind[] = _("A sharp wind that\nhas a chance to\nflinch the foe.");
...
const u8 gMoveDescription_SkyAttack[] = _("Strikes from above\n with devastating\n power.");
...
const u8 gMoveDescription_Sandstorm[] = _("A 10-turn sandstorm\nthat damages all\ntypes except ROCK,\nGROUND, and STEEL.");
...
const u8 gMoveDescription_LeafBlade[] = _("Sharp leaf slash\nwith high crit.\nMay raise crit-ratio");
