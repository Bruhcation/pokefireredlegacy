...
static const struct RematchData sRematches[] = {
   ...
   { {TRAINER_SIS_AND_BRO_LIL_IAN, SKIP, SKIP, SKIP, TRAINER_SIS_AND_BRO_LIL_IAN_2, TRAINER_SIS_AND_BRO_LIL_IAN_3},
      MAP(ROUTE21_NORTH) },
   { {TRAINER_CUE_BALL_CHASE, TRAINER_CUE_BALL_CHASE},
      MAP(ROUTE21_NORTH) },
   ...
   { {TRAINER_ROCKER_RANDALL, TRAINER_ROCKER_RANDALL},
      MAP(DOWNWARD_BEACH) },
   { {TRAINER_BIRD_KEEPER_REED, TRAINER_BIRD_KEEPER_REED},
      MAP(DOWNWARD_BEACH) },
   ...
   { {TRAINER_BEAUTY_LAUREN, TRAINER_BEAUTY_LAUREN},
      MAP(FIVE_ISLAND_WATER_LABYRINTH) },
   ...
   { {TRAINER_COOLTRAINER_PAUL, TRAINER_COOLTRAINER_PAUL}, MAP(SIX_ISLAND_GREEN_PATH) },
   { {TRAINER_COOLTRAINER_GILBERT, TRAINER_COOLTRAINER_GILBERT}, MAP(SIX_ISLAND_GREEN_PATH) },
   { {TRAINER_PICNICKER_HANNAH, TRAINER_PICNICKER_HANNAH}, MAP(SIX_ISLAND_GREEN_PATH) },
   { {TRAINER_TAMER_JOHN, TRAINER_TAMER_JOHN}, MAP(SIX_ISLAND_GREEN_PATH) },
   { {TRAINER_GENTLEMAN_WALTER, TRAINER_GENTLEMAN_WALTER}, MAP(SIX_ISLAND_GREEN_PATH) },
   ...
   { {TRAINER_HIKER_EARL, SKIP, SKIP, SKIP, SKIP, TRAINER_HIKER_EARL_2},
      MAP(SIX_ISLAND_WATER_PATH) },
   { {TRAINER_COOLTRAINER_BROOKE, TRAINER_COOLTRAINER_BROOKE},
      MAP(SIX_ISLAND_WATER_PATH) },
   { {TRAINER_COOLTRAINER_OWEN, TRAINER_COOLTRAINER_OWEN},
      MAP(SIX_ISLAND_WATER_PATH) },
   ...
   { {TRAINER_GENTLEMAN_CLIFFORD, TRAINER_GENTLEMAN_CLIFFORD},
      MAP(SEVEN_ISLAND_TANOBY_RUINS) },
   { {TRAINER_BIRD_KEEPER_KEITH, TRAINER_BIRD_KEEPER_KEITH},
      MAP(SEVEN_ISLAND_TANOBY_RUINS) },
};
