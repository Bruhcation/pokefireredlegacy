...
ALIGNED(4) const u8 gText_EmeraldLegacy[] = _("FRLG NORMAL");
ALIGNED(4) const u8 gText_LegacyHard[] = _("FRLG HARD");
ALIGNED(4) const u8 gText_LegacyHardcore[] = _("FRLG HARDCORE");
...
const u8 gText_DexEvolvesInto[]    = _("Evolves into");
const u8 gText_DexEvoUnknown[]     = _("???");
const u8 gText_DexTradeHolding[] = _("Trade holding ");
const u8 gText_DexNewLine[] = _("\n");
const u8 gText_DexIndirectMarker[] = _("  L ");
const u8 gText_DexEvolvesIntoHeader[]  = _(" Evolves into:\n");
const u8 gText_DexDoesntEvolveHeader[] = _(" Doesn't evolve");
const u8 gText_DexColon[]              = _(": ");
const u8 gText_DexLevel[]              = _("Level ");
const u8 gText_DexIsReached[]          = _(" is reached");
const u8 gText_DexIsUsed[]             = _(" is used");
const u8 gText_DexHighFriendship[]     = _("High friendship");
const u8 gText_DexTraded[]             = _("Trade");
const u8 gText_DexAtkGreater[]    = _(", Atk > Def");
const u8 gText_DexAtkEqual[]      = _(", Atk = Def");
const u8 gText_DexAtkLess[]       = _(", Atk < Def");
const u8 gText_DexShedinjaNote[]  = _(", room + Poke Ball");
const u8 gText_EvolutionsPreviousData[] = _("{A_BUTTON}EVOLUTIONS {B_BUTTON}PREVIOUS DATA");
const u8 gText_DexMoveEggPrefix[]  = _("Egg  ");
const u8 gText_DexMoveLvPrefix[]   = _("Lv");
const u8 gText_DexMoveTMPrefix[]   = _("TM");
const u8 gText_DexMoveHMPrefix[]   = _("HM");
const u8 gText_DexMoveTutorPrefix[] = _("Tutr ");
const u8 gText_DexMoveSpace[]      = _(" ");
const u8 gText_DexPowerLabel[]     = _("Pwr:");
const u8 gText_DexAccLabel[]       = _(" Acc:");
const u8 gText_DexThreeHyphens[]   = _("---");
const u8 gText_DexArrowMark[] = _("{RIGHT_ARROW}");
const u8 gText_MovesPreviousData[] = _("{A_BUTTON}MOVES {B_BUTTON}PREVIOUS DATA");
const u8 gText_SelectAbility[]     = _("{SELECT_BUTTON}ABILITY");
const u8 gText_SelectStats[]     = _("{SELECT_BUTTON}BASE STATS");
const u8 gText_DexStatHP[]    = _("HP");
const u8 gText_DexStatAtk[]   = _("ATK");
const u8 gText_DexStatDef[]   = _("DEF");
const u8 gText_DexStatSpA[]   = _("SP.A");
const u8 gText_DexStatSpD[]   = _("SP.D");
const u8 gText_DexStatSpe[]   = _("SPE");
const u8 gText_DexStatTotal[] = _("TOTAL:");
...
const u8 gText_MonBallWasChanged[] = _("{STR_VAR_1} was put in the\n{STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_WontHaveEffectHardcore[] =_("Your POKéMON wants to battle more \ntrainers!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Tm13_2500Coins[] = _("TM13{CLEAR_TO 0x48}{FONT_SMALL}3,000 COINS");
const u8 gText_Tm23_2000Coins[] = _("TM23{CLEAR_TO 0x48}{FONT_SMALL}2,500 COINS");
const u8 gText_Tm24_2500Coins[] = _("TM24{CLEAR_TO 0x48}{FONT_SMALL}3,000 COINS");
const u8 gText_Tm30_3000Coins[] = _("TM30{CLEAR_TO 0x48}{FONT_SMALL}3,500 COINS");
const u8 gText_Tm35_2500Coins[] = _("TM35{CLEAR_TO 0x48}{FONT_SMALL}3,000 COINS");
...
const u8 gText_Dratini_3000Coins[] = _("DRATINI{CLEAR_TO 0x4B}{FONT_SMALL} 3,000 COINS");
const u8 gText_Kangaskan_2000Coins[] = _("KANGASKHAN{CLEAR_TO 0x4B}{FONT_SMALL} 2,000 COINS");
const u8 gText_Porygon_4000Coins[] = _("PORYGON{CLEAR_TO 0x4B}{FONT_SMALL} 4,000 COINS");
...
const u8 gText_MiracleSeed_500Coins[] = _("MIRACLE SEED{CLEAR_TO 0x5A}{FONT_SMALL}750 COINS");
const u8 gText_Charcoal_500Coins[] = _("CHARCOAL{CLEAR_TO 0x5A}{FONT_SMALL}750 COINS");
const u8 gText_MysticWater_500Coins[] = _("MYSTIC WATER{CLEAR_TO 0x5A}{FONT_SMALL}750 COINS");
const u8 gText_UpGrade_1500Coins[] = _("UP GRADE{CLEAR_TO 0x50}{FONT_SMALL}1,500 COINS");
const u8 gText_SmokeBall_250Coins[] = _("SMOKE BALL{CLEAR_TO 0x5A}{FONT_SMALL}500 COINS");
...
const u8 gText_Energypowder_50[] = _("ENERGYPOWDER{CLEAR_TO 0x7A}{FONT_SMALL}50");
const u8 gText_EnergyRoot_80[] = _("ENERGY ROOT{CLEAR_TO 0x7A}{FONT_SMALL}50");
const u8 gText_HealPowder_50[] = _("HEAL POWDER{CLEAR_TO 0x7A}{FONT_SMALL}50");
const u8 gText_RevivalHerb_300[] = _("REVIVAL HERB{CLEAR_TO 0x7A}{FONT_SMALL}50");
const u8 gText_Protein_1000[] = _("PROTEIN{CLEAR_TO 0x75}{FONT_SMALL}500");
const u8 gText_Iron_1000[] = _("IRON{CLEAR_TO 0x75}{FONT_SMALL}500");
const u8 gText_Carbos_1000[] = _("CARBOS{CLEAR_TO 0x75}{FONT_SMALL}500");
const u8 gText_Calcium_1000[] = _("CALCIUM{CLEAR_TO 0x75}{FONT_SMALL}500");
const u8 gText_Zinc_1000[] = _("ZINC{CLEAR_TO 0x75}{FONT_SMALL}500");
const u8 gText_HpUp_1000[] = _("HP UP{CLEAR_TO 0x75}{FONT_SMALL}500");
const u8 gText_PpUp_3000[] = _("PP UP{CLEAR_TO 0x75}{FONT_SMALL}500");
...
const u8 gText_PokeSum_Controls_PageIV[] = _("{DPAD_LEFTRIGHT}PAGE {A_BUTTON}IV");
const u8 gText_PokeSum_Controls_PageEV[] = _("{DPAD_LEFTRIGHT}PAGE {A_BUTTON}EV");
const u8 gText_PokeSum_Controls_PageStats[] = _("{DPAD_LEFTRIGHT}PAGE {A_BUTTON}STATS");
...
const u8 gText_HackOptions[] = _("DEV OPTIONS");
const u8 gText_DevOnly[] = _("DEV ONLY");
...
ALIGNED(4) const u8 gString_PokemonFireRed_Staff[] = _("Pokémon FireRed Reignited\nStaff");
ALIGNED(4) const u8 gString_PokemonLeafGreen_Staff[] = _("Pokémon LeafGreen Regrown\nStaff");
ALIGNED(4) const u8 gCreditsString_Director[] = _("\nDirector\n\nHack Creator\n\n\n");
ALIGNED(4) const u8 gCreditsString_Junichi_Masuda[] = _("\n\nJunichi Masuda\n\nSpikeCation\n\n");
ALIGNED(4) const u8 gCreditsString_RomLead[] = _("\n\nDevolper\n\n\n\n");
ALIGNED(4) const u8 gCreditsString_SpikeCation[] = _("\n\n\nSpikeCation\n\n\n");
