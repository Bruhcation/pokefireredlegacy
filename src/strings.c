...
const u8 gText_Energypowder_50[] = _("ENERGYPOWDER{CLEAR_TO 0x65}{FONT_SMALL}50");
const u8 gText_EnergyRoot_80[] = _("ENERGY ROOT{CLEAR_TO 0x65}{FONT_SMALL}50");
const u8 gText_HealPowder_50[] = _("HEAL POWDER{CLEAR_TO 0x65}{FONT_SMALL}50");
const u8 gText_RevivalHerb_300[] = _("REVIVAL HERB{CLEAR_TO 0x65}{FONT_SMALL}50");
