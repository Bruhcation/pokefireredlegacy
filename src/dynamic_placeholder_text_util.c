...
static const u8 sTextColorTable[] =
{
 // [LOW_NYBBLE / 2]                            = 0xXY, // HIGH_NYBBLE
    ...
    [OBJ_EVENT_GFX_FALKNER / 2]                 = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_BUGSY
    [OBJ_EVENT_GFX_WHITNEY / 2]                 = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_MORTY
    [OBJ_EVENT_GFX_CHUCK / 2]                   = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_JASMINE
    [OBJ_EVENT_GFX_PRYCE / 2]                   = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_CLAIR
    [OBJ_EVENT_GFX_SWIMMER_F_WATER_2 / 2]       = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_SUDOWOODO_2
};
